...
//    }
	...
	/**
	 * Parse a string with color information and returns the JMColor associated. If
	 * the string begins with "#" parses hexadecimal numbers in 3, 6 or 8 digits. If
	 * the string equals one of the defined names ("white", "blue", etc.), returns
	 * this color. The names are case-insensitive.
	 *
