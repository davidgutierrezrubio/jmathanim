...
public class MODrawProperties implements Stylable, Stateable {
	...
	/**
	 * Returns a new {@link MODrawProperties} created from the current style. If no
	 * such style exists, a default MathObjectDrawingProperties is created.
	 *
	...
	/**
	 * Generates a MODrawProperties instance with all its values null. It is useful
	 * if you want to interpolate only some values. By default, null values are not
	 * interpolated or copied.
	 *
	 * @return
	 */
	...
	/**
	 * Returns Dash Style, from its name, using reflection. Used when loading config
	 * files.
	 *
	...
	public void interpolateFrom(Stylable a, Stylable b, double alpha) {
		...
		// If not, getInterpolatedColor drawColor, fillColor and thickness (if they are
		// not null)
		// Interpolate colors
