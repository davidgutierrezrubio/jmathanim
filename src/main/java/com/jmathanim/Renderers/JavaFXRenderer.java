...
//        return mathScalar * config.mediaW / (xmax - ymin);
	...
	/**
	 * Returns equivalent position from default camera to fixed camera. For example
	 * if you pass the Vec (1,1) to this method, it will return a new set of
	 * coordinates so that, when rendered with the fixed camera, appears in the same
