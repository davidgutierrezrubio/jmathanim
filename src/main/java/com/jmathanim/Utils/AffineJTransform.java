...
public class AffineJTransform  {
    ...
    public static AffineJTransform create2DRotationTransform(Coordinates<?> center, double angle) {
        ...
        AffineJTransform tr1 = AffineJTransform.createTranslationTransform(center.getVec().copy().scale(-1));
    ...
    public static AffineJTransform createDirect2DIsomorphic(Coordinates<?> originA, Coordinates<?> originB, Coordinates<?> destinyA, Coordinates<?> destinyB, double alpha) {
        ...
        AffineJTransform translation = AffineJTransform.createTranslationTransform(v3.copy().scale(alpha));
    ...
    public static AffineJTransform createDirect3DIsomorphic(Coordinates<?> A, Coordinates<?> B1,
        ...
        AffineJTransform shift1=AffineJTransform.createTranslationTransform(A.getVec().copy().scale(-1));
        //And the inverse one
        ...
        // The translation part
        AffineJTransform translation = AffineJTransform.createTranslationTransform(vShift.copy().scale(alpha));
