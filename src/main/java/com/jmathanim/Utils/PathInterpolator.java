...
public class PathInterpolator {
	...
	/**
	 * Generate control points from a bezier cubic curve, so that control points of
	 * point n are parallel to the line from point n-1 and n+1. The distance from
	 * point n to the control points is multiplied by the 0 to 1 tension parameter.
	 * A 1 tension means straight lines. If first and last point are not connected,
	 * an approximation is used based on the control point of their neighbour points
	 *
