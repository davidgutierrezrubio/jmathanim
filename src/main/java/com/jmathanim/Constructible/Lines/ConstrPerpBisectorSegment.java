...
public class ConstrPerpBisectorSegment extends Constructible implements HasDirection {
    ...
    @Override
    public ConstrPerpBisectorSegment copy() {
        ConstrPerpBisectorSegment copy = new ConstrPerpBisectorSegment(segment.copy());
    ...
    public void rebuildShape() {
        Point C = segment.A.getMathObject().interpolate(segment.B.getMathObject(), .5);
