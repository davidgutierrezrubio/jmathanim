 ...
 */
public abstract class AffineTransformAnimation extends Animation {
    ...
    public void doAnim(double t) {
        ...
        for (MathObject obj : mathObjects) {
            AffineJTransform tr = getTransform(lt);
     ...
     */
    public abstract AffineJTransform getTransform(double t);
}
