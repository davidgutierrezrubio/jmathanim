...
public abstract class ShiftAnimation extends Animation {
	 ...
	 * @return the jump height of the given object. A value or null or zero means no
	 *         jump at all.
	 */
	 ...
	 * @return Amount of scale to apply to the object. A value of null or 1 means no
	 *         effect
	 */
	...
	/**
	 * Adds a jump effect to the shift animation.The direction of the jump is the
	 * shift vector rotated 90 degrees counterclockwise.
	 *
	...
	/**
	 * Adds a rotation effect with a specified angle to every mathobject added to
	 * the animation
	 *
	 * @param <T>           The calling subclass
	...
	/**
	 * Adds a rotation effect with a specified angle to a given mathobject added to
	 * the animation
	 *
	 * @param <T>           The calling subclass
	 ...
	 * @param alphaScale The amount to scale. A value of .5 will reduce the alpha to
	 *                   50% at the middle of the animation.
	 * @return This object
	 */
	...
	/**
	 * Sets the delay percentage. A number between 0 and 1 that controls the time
	 * gap between consecutive objects when shifting multiple ones. For example, if
	 * you set the delay to 0.75, all shift animations will last 25 percent of
	 * initial time, evenly spaced over the total duration of the animation. So, for
	 * an animation who shifts 3 objects for 2 seconds, each one will last 2*0.25=.5
	 * seconds, starting at 0, .75 and 1.5 respectively
	 *
