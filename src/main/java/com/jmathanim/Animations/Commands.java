...
//        };
	 ...
	 *         {@link JMathAnimScene#playAnimation(com.jmathanim.Animations.Animation...)
	...
	/**
	 * Changes the draw color and fill color of the objects to the given one. If one
	 * of the colors is null, the colors are not changed Thus, if you want to change
	 * only drawColor, you should set fillColor to null.
	 *
	 * @param runtime   Duration in seconds
	...
	/**
	 * Animation command that changes the math drawing properties of given object,
	 * interpolating
	 *
	...
	/**
	 * Performs the inverse animation than {@link shrinkOut}, that its, scale the
	 * size and alpha of the object from zero.
	 *
	 *
	 * @param runtime Duration time in seconds
	 * @return Animation to run with
	...
	/**
	 * Performs the inverse animation than {@link shrinkOut}, that its, scale the
	 * size and alpha of the object from zero. An inverse rotation from given angle
	 * to 0 is performed.
	 *
	...
	/**
	 * Performs an animation modifying the alpha of the object to 0. Both drawAlpha
	 * and fillAlpha are animated. Object is removed from current scene after
	 * finishing animation.
	 *
	 * @param runtime Duration time in seconds
	 ...
	 *
	 * @param runtime Duration in seconds
	 * @param corner  Corner to layout from. If null, first object of the group will
	 *                be used
	...
	/**
	 * Animated version of the stackTo method.The destination point is computed at
	 * the initialize() method so it cab ne safely concatenated. If several objects
	 * are animated, the second will be stacked to the first, and so on
	 *
	 * @param runtime     time in seconds
	 * @param dst         Destiny object to align with
	...
	/**
	 * Animates a crossout. The size of the crossout is computed from the bounding
	 * box of the crossed object
	 *
	 * @param runtime Duration in seconds
