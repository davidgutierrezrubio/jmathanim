...
public class Transform extends Animation {
    ...
    public void doAnim(double t) {
        ...
        for (int n = 0; n < mobj1.jmpath.points.size(); n++) {
            ...
            p = mobj1.jmpath.controlPoints1.get(n).p;
            a = jmpathOrig.controlPoints1.get(n).p;
            b = mobj2.jmpath.controlPoints1.get(n).p;
            ...
            p = mobj1.jmpath.controlPoints2.get(n).p;
            a = jmpathOrig.controlPoints2.get(n).p;
            b = mobj2.jmpath.controlPoints2.get(n).p;
