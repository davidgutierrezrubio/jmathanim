...
//    private boolean isEnded = false;
	...
	/**
	 * Lambda smooth function, ideally a growing function that maps 0 into 0 and 1
	 * into 1
	 */
...
//    }
	/**
	 * Return the use object state flag. This flag controls whether the animation
	 * should restore the initial state of the object prior to do each frame of the
	 * animation.
	 *
	 ...
	 * should restore the initial state of the object prior to do each frame of the
	 * animation.By default is true,but it may be necessary to set to false when
	 * combining 2 animations. For example a shift and a rotation, should deactivate
	 * the flag in the second.
	 *
...
//    }
	/**
	 * Creates an empty animation, with specified run time.This constructor should
	 * be called only from implementing subclasses.
	 *
...
//        scene = JMathAnimConfig.getConfig().getScene();
	...
	/**
	 * Sets the frames per second. This value is automatically set by the initialize
	 * method
	 *
...
//        dt = 1.d / (runTime * fps + 3);
	 ...
	 *          needed by some special animations. The lambda function should be
...
//	}
	...
	/**
	 * Sets the optimization strategy.If null, the animation will try to find the
	 * most suitable optimization.
	 *
	...
	/**
	 * Add the specified objects to the scene. Adding objects to the scene should be
	 ...
	 *
	 * @return A value of the enum Status, NOT_INITIALIZED, INITIALIZED, RUNNING,
	 *         FINISHED
	 */
	...
	/**
	 * Sets the time parameter. A value or 0 means beginning of the animation and 1
	 * the ending.
	 *
