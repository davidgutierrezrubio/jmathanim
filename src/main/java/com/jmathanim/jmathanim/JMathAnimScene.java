...
public abstract class JMathAnimScene {
	...
	/**
	 * Previous nanotime in the last measure, used to control frame rate in preview
	 * window
	 */
	...
	/**
	 * Returns the list of objects to be updated. Note that this doesn't necessarily
	 * matchs with objects drawn
	 *
	 * @return An ArrayList of MathObject
	 */
	...
	/**
	 * An abstract method to be overriden. Actual animations are implemented here.
	 *
	 ...
	 * updateable objects and then draw all objects added to the scene. Objects are
	 * sorted by layer, so that lower layers means drawing under.
	 */
	...
	/**
	 * Save the current frame using the renderer. Renderer should save the frame to
...
//                    anim.finishAnimation();
	...
	/**
	 * Reset the scene, deleting all objects, unregistering updaters, and setting
	 * the camera to its default values
	 */
	public void reset() {
