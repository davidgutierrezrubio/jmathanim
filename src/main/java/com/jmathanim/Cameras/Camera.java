...
public class Camera {
	...
	/**
	 * Set the boundaries of the math region displayed in the screen given by xmin
	 * and xmax. ymin and ymax are automatically computed Rectangle (xmin,ymin) to
	 * (xmax, ymax) vertically centered at ycenter
	 *
...
//        resul = (int) ((mathScalar - xmin) + mathScalar * screenWidth / xmax);
	...
	/**
	 * Set size of the screen to which the camera will compute coordinates Screen
	 * size usually is 800x600, 1920x1080, etc.
	 *
	 * @param w width
	 * @param h height
	 */
	...
	/**
	 * Adjust the view so that if contains the area given by a Rect object.The view
	 * is the minimal bounding box that contains r, with the proportions of the
	 * screen.
	 *
	...
	/**
	 * Adjust the camera view so that all objects in the scene are visible, zooming
	 * out as necessary. The difference with the zoom methods is that a zoom in is
	 * not applied in this case. The setGaps method can be called before to set the
	...
	/**
	 * Zoom the camera so that the specified objects are visible (objects don't need
	 * to be added to the scene). The setGaps method can be called before to set the
	 * gaps between the view and the objects.
	 *
	 * @return This object
	 */
	 ...
	 * method can be called before to set the gaps between the view and the objects.
	 *
	 * @return This object
	 */
	 ...
	 *
	 * @param scale Scale factor. A value of 1 does nothing. A value of 0.5 applies
	 *              a 2x zoom.
	 * @return This object
	 */
