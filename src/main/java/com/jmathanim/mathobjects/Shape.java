...
//    }
	...
	/**
	 * Merges with the given Shape, adding all their jmpathpoints.If the shapes were
	 * disconnected they will remain so unless the connect parameter is set to true.
	 * In such case, the shapes will be connected by a straight line from the last
	 * point of the calling object to the first point of the given one.
	 *
	 ...
	 *                useful for filling purposes if you are trying to add a "hole"
	 *                to a shape
	 * @return This object
	 */
	 ...
	 *
	 * @param A First point
	 * @param B Second point. The fourth point will be the opposite of this point.
	 *          This will be the point with index 0 in the path.
	 * @param C Third point
	 * @return The rectangle
	 */
...
//        writeFXPathPoints(convertToPath);
	...
	/**
	 * Creates a new Shape object with the intersection of this Shape and another
	 * one. Styling properties of the new Shape are copied from calling object.
	 *
	 * @param s2 Shape to intersect with
...
//        fXPathUtils.distille(convertToPath);
	...
	/**
	 * Creates a new Shape object with the substraction of this Shape with another
	 * one. Styling properties of the new Shape are copied from calling object.
	 *
	 * @param s2 Shape to substract
