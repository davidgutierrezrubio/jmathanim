...
public class ParametricCurve extends Shape {
	...
	/**
	 * Creates a new parametric curve in cartesian coordinates (x(t),y(t)), using
	 * the default number of points defined in {@link DEFAULT_NUMBER_OF_POINTS}
	 *
	...
	/**
	 * Creates a new parametric curve in polar coordinates (r(t),theta(t)), using
	 * the default number of points defined in {@link DEFAULT_NUMBER_OF_POINTS}
	 *
...
//            double y = getFunctionValueY(t);
	 ...
	 * t-points. If the t parameter is already included, this method has no effect,
	 * other than recalcuating control points.
	 *
	 * @param tPoints t coordinates of the independent variable to include. Variable
	 *                number of arguments.
	 */
