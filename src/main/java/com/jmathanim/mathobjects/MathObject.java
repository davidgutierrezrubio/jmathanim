...
public abstract class MathObject implements Drawable, Updateable, Stateable, Boxable {
	...
	/**
	 * Sets the flag visible. If false, the object won't be draw using the renderer,
	 * although it still will be in the scene.
	 *
	 * @param <T>     Subclass of MathObject that calls the method
	 * @param visible
	 * @return This MathObject subclass
	...
	/**
	 * Marks this object with the absolute size flag.In this case, it will be drawn
	 * using a fixed camera, so that it will appear with the same size regardless of
	 * the zoom applied to the camera. The given point will be used as reference
	 * point to position the object.
	 *
	 * @param <T> Mathobject subclass
	 ...
	 * LEFT anchor matchs the RIGHT anchor of the destiny. This method is equivalent
	 * to stackTo(obj,type,0)
	 *
	 * @param <T>        Mathobject subclass
	 ...
	 * Stack the object to another using a specified anchor. For example
	 * stackTo(UPPER, obj, RIGHT) will move this object so that its UPPER anchor
	 * matchs the RIGHT anchor of the destiny. The difference with similar methods
	 * is that the gap is given relative to this object width.
	 *
	 * @param <T>        Mathobject subclass
	 * @param anchorObj  Anchor of this object to use
	 * @param dstObj     Destiny object to stack with
	 * @param anchorType Anchor of destiny object to use
	 * @param gap        Amount of gap, relative to this object width, to leave
	 ...
	 * stackTo(UPPER, obj, RIGHT) will move this object so that its UPPER anchor
	 * matchs the RIGHT anchor of the destiny. The difference with similar methods
	 * is that the gap is given relative to this object height.
	 *
	 * @param <T>        Mathobject subclass
	 * @param anchorObj  Anchor of this object to use
	 * @param dstObj     Destiny object to stack with
	...
	/**
	 * Stack the object to another using a specified anchor. For example
	 * stackTo(obj, RIGHT) will move this object so that its LEFT anchor matchs the
	 * RIGHT anchor of the destiny. The difference with similar methods is that the
	 * gap is given relative to this object height.
	 *
	 * @param <T>        Mathobject subclass
	 * @param dstObj     Destiny object to stack with
	 * @param anchorType Anchor of destiny object to use
	 ...
	 * stackTo(obj, RIGHT) will move this object so that its LEFT anchor matchs the
	 * RIGHT anchor of the destiny. The difference with similar methods is that the
	 * gap is given relative to this object width.
	 *
	 * @param <T>        Mathobject subclass
	 * @param dstObj     Destiny object to stack with
	 * @param anchorType Anchor of destiny object to use
	...
	/**
	 * Overloaded method. Shifts the object so that its center lies at the specified
	 * location
	 *
	 * @param <T> Mathobject subclass
	 ...
	 * Marks this object with the absolute size flag. In this case, it will be drawn
	 * using a fixed camera, so that it will appear with the same size regardless of
	 * the zoom applied to the camera. The center of the object will be used as
	 ...
	 * Marks this object with the absolute size flag.In this case, it will be drawn
	 * using a fixed camera, so that it will appear with the same size regardless of
	 * the zoom applied to the camera. The specified anchor will be used as
	 * reference point to position the object.
	 *
	 * @param <T>        Mathobject subclass
	 * @param anchorType {@link Anchor} type
	...
	/**
	 * Sets the layer where this object belongs. Lower layers means that the object
	 * will be drawed first and appear under other objects. The number can be any
	 * integer
	 *
	 * @param <T>   MathObject subclass
	...
	/**
	 * Sets the given style, as defined in config files. If no such style exists,
	 * there is no effect, apart from a warning message
	 *
	 * @param <T>  MathObject subclass
