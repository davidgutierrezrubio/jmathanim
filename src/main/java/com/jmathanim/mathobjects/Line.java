...
public class Line extends Shape implements HasDirection {
	...
	/**
	 * Creates a new Line object. Line is a Shape object with 2 points, as a Segment
	 * but it overrides the draw method so that it extends itself to all the view,
	 * to look like an infinite line.
	 *
	 * @param a First point
	...
	/**
	 * Compute border points in the view area of the given renderer.This is need in
	 * order to draw an "infinite" line which always extend to the whole visible
	 * area. The border points are stored in bp1 and bp2
	 *
	...
	/**
	 * Returns the point of the line lying in the boundaries of the math view. From
	 * the 2 points of the boundary, this is next to p1.
	 *
	...
	/**
	 * Returns the point of the line lying in the boundaries of the math view. From
	 * the 2 points of the boundary, this is next to p2.
	 *
	 * @param scene The scene, needed to obtain the math view
	 * @return A copy of the boundary point
	 */
	...
	/**
	 * Returns the center of the object. As the center of an infinite line doesn't
	 * exists. Take middle point of p1 and p2 instead.
	 *
