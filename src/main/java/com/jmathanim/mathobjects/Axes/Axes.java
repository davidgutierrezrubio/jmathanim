...
public class Axes extends MathObject {
	...
	/**
	 * Adds a pair (tick, legend text) at the given value in the x-axis.The text is
	 * automatically generated from the value of x.The maxWidthToShow parameter is
	...
	/**
	 * Adds a pair (tick, legend text) at the given value in the y-axis, with the
	 * specified latex string.The maxWidthToShow parameter is the maximum width of
...
//    }
	/**
	 * Adds a pair (tick, legend text) at the given value in the y-axis.The text is
	 * automatically generated from the value of y. The maxWidthToShow parameter is
	 * the maximum width of the math view to show this tick. A value of 0 means
	 * always show this tick
	 *
	...
	/**
	 * Generates a set of pairs (ticks-legends) from start to finish (including)
	 * with given step, in the x-axis. The primary ticks are slightly bigger than
	 * the secondary, and they are always shown on the screen
	 *
	 * @param start  Starting number
	 * @param finish Ending number
	 * @param step   Step
	...
	/**
	 * Generates a set of pairs (ticks-legends) from start to finish (including)
	 * with given step, in the y-axis. The primary ticks are slightly bigger than
	 * the secondary, and they are always shown on the screen
	 *
	 * @param start  Starting number
	 * @param finish Ending number
	 ...
	 * width of the math view to show this tick.A value of 0 means always show this
	 * tick.
	 *
	 * @param start          Starting number
	 * @param finish         Ending number
