...
public class TippableObject extends MathObject {
	 ...
	 * @param tip       MathObject to tip. This object is not drawed, but a copy of
	 *                  it properly scaled and rotated.
	 * @return The tippable object.
	 */
	public static TippableObject make(Shape shape, double location, TippableObject.slopeDirection direction,
			MathObject tip) {
	...
	public static TippableObject arrowHead(Shape shape, double location, slopeDirection direction,
			Arrow2D.ArrowType type) {
	 ...
	 *
	 * @param location A number between 0 and 1. If the number lies outside of this
	 *                 range, it is normalized.
	 */
	...
	/**
	 * Sets the object to use to build the tip.Note that this object is not drawed,
	 * but a copy properyl rotated and scaled.
	 *
	...
	/**
	 * Returns the tipped object, properly scaled and rotated. This is the object
	 * that will be drawed in the next draw routine.
	 *
...
//        return shape.getUpdateLevel() + 1;
	 ...
	 *
	 * @param <T>
	 * @param angle Offset angle. A value of 0 means that the tip is rotated along
	 *              the direction of the shape in the location point.
	 * @return This object
	 */
