...
public class LaTeXMathObject extends SVGMathObject {
	...
	/**
	 * Changes the current LaTeX expression, updating the whole object as needed.The
	 * JMNumber for example, uses this.The new formula generated will be
	 * center-aligned with the replaced one. In case the old formula was empty (no
	 * shapes) it will be centered on the screen.
	 *
