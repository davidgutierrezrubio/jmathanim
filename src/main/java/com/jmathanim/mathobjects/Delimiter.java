...
public class Delimiter extends MathObject {
	...
	/**
	 * Returns the scale of the delimiter. A value of 1 draws the delimiter from one
	 * anchor point to another. Smaller values scales the delimiter in the same
	 * proportion. This value is used mainly for showCreation animations-like.
	 *
